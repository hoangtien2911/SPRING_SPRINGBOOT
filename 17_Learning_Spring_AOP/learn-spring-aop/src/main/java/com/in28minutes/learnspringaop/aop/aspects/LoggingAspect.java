...
public class LoggingAspect {
	...
	// Pointcut - When?
	// execution(* PACKAGE.*.*(..))
	@Before("com.in28minutes.learnspringaop.aop.aspects.CommonPointcutConfig.businessAndDataPackageConfig()") // WHEN
	...
	@AfterThrowing(pointcut = "com.in28minutes.learnspringaop.aop.aspects.CommonPointcutConfig.businessAndDataPackageConfig()", throwing = "exception")
	public void logMethodCallAfterException(JoinPoint joinPoint, Exception exception) {
		logger.info("AfterThrowing Aspect - {} has thrown an exception {}", joinPoint, exception);
	}

	@AfterReturning(pointcut = "com.in28minutes.learnspringaop.aop.aspects.CommonPointcutConfig.dataPackageConfig()", returning = "resultValue")
