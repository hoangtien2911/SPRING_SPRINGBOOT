...
class CriteriaQueryTest {
	...
	public void all_courses() {
		...
		logger.info("1. Typed Query -> {}", resultList);
	...
	public void all_courses_having_100Steps() {
		...
		logger.info("2. Typed Query -> {}", resultList);
	...
	public void all_courses_without_students() {
		...
		logger.info("3. Typed Query -> {}", resultList);
	...
	public void join() {
		...
		logger.info("4. Typed Query -> {}", resultList);
		// [Course[JPA in 50 Steps], Course[JPA in 50 Steps], Course[JPA in 50
		// Steps], Course[Spring Boot in 100 Steps]]
//		4. Typed Query -> [Course[JPA in 50 Steps], Course[Spring Boot in 100 Steps]]
	}
	...
	public void left_join() {
		...
		logger.info("5. Typed Query -> {}", resultList);
		for (Course course : resultList) {
			logger.info("1. Course: {}", course);
		}
		// [Course[JPA in 50 Steps], Course[JPA in 50 Steps], Course[JPA in 50
